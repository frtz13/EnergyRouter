...
class EnergyRouter(hass.Hass, mqtt.Mqtt):
    async def initialize(self):
        ...
        await self.run_in(self.energy_router_loop, 2) # This call also need to be awaited. 
...
# ============== main loop ===================
    ...
    # do some async stuff  
        ...
        while(True):
            ...
            # self.log(f"Gridpower {self._gridpower}, {i}")
